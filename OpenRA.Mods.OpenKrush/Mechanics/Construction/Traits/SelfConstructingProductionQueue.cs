...
public class SelfConstructingProductionQueueInfo : AdvancedProductionQueueInfo
{
	...
	{
		return new SelfConstructingProductionQueue(init, this);
	}
}
...
public class SelfConstructingProductionQueue : AdvancedProductionQueue
{
	...
	public SelfConstructingProductionQueue(ActorInitializer init, SelfConstructingProductionQueueInfo info)
		: base(init, info)
	{
	}
