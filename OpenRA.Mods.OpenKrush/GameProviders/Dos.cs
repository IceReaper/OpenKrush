...
namespace OpenRA.Mods.OpenKrush.GameProviders
{
    public static class Dos
    {
        public static bool TryRegister(string path)
        {
            ...
            GameProvider.Music.Add(files["surv1.son"], "Survivors 1");
            GameProvider.Music.Add(files["surv2.son"], "Survivors 2");
            GameProvider.Music.Add(files["surv3.son"], "Survivors 3");
            GameProvider.Music.Add(files["mute1.son"], "Evolved 1");
            GameProvider.Music.Add(files["mute2.son"], "Evolved 2");
            GameProvider.Music.Add(files["mute3.son"], "Evolved 3");
