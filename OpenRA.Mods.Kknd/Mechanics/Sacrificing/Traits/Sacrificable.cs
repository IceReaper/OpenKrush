...
using OpenRA.Mods.Kknd.Mechanics.Sacrificing.Activities;
using OpenRA.Mods.Kknd.Mechanics.Sacrificing.Orders;
using OpenRA.Primitives;
using OpenRA.Traits;

namespace OpenRA.Mods.Kknd.Mechanics.Sacrificing.Traits
{
